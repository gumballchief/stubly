...
async function modelPick(text) {
  ...
  const prompt = [
    ...
    "- Choosing the agent and extracting the input are SEPARATE decisions. Someone who says",
    '  "I need cold emails" without saying what they sell has still told you which agent they',
